...
module.exports = ({ production }, { analyze, hmr, port, host }) => ({
  ...
  module: {
    rules: [
        ...
        { test: /\.woff2(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'url-loader', options: { limit: 10000, mimetype: 'font-woff2', name: 'fonts/[hash].[ext]' } },
        { test: /\.woff(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'url-loader', options: { limit: 10000, mimetype: 'font-woff', name: 'fonts/[hash].[ext]' } },
        { test: /\.(ttf|eot|svg|otf)(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'file-loader', options: { name: 'fonts/[hash].[ext]' } }
    ]
},
  plugins: [
